...
<body>
    <nav class="navbar bg-primary navbar-dark navbar-expand-sm fixed-top">
                <span class="navbar-text">
                		<!-- id="login_link" -->
                    <a href="admin.html"><i class="fa fa-sign-out ml-5"></i><input type="submit" class="btn btn-primary p-0"  value="back"/></a>
                </span>
    ...
    <div class="container">
        <div class="row row-content">
            <div class="col-12 col-sm-9">
                <h2>Driver has been Removed Successfully</h2>
                    ...
                    <table class="table table-striped">
                        ...
                        <%
	                        ...
	                        try {
		            			...
		            			PreparedStatement st=  con.prepareStatement("select fullname,email,username from users where email=?");
		            			st.setString(1, id);
                        ...
                        <%
		            			  ...
		            			  PreparedStatement del=  con.prepareStatement("delete from drivers where emailid=?");
		            			  del.setString(1, id);
		            			  del.executeUpdate();
		            			  del=  con.prepareStatement("delete from users where email=?");
		            			  del.setString(1, id);
		            			  del.executeUpdate();
		            		}
		            		catch(Exception e) {
