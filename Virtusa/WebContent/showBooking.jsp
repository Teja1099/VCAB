...
<body>
    <nav class="navbar bg-primary navbar-dark navbar-expand-sm fixed-top">
                <span class="navbar-text">
                		<!-- id="login_link" -->
                    <a href="driver.html"><i class="fa fa-sign-out ml-5"></i><input type="submit" class="btn btn-primary p-0"  value="back"/></a>
                </span>
                    ...
                    <table class="table table-striped">
                        ...
                        <%
	                        ...
	                        try {
		            			...
		            			PreparedStatement st=  con.prepareStatement("select passenger,place,price from transaction where driver=? and status=?");
		            			st.setString(1, email);
		            			st.setString(2, "active");
		            			ResultSet rs= st.executeQuery();
		            			  if(rs.next())
		            			  {
									useremail=rs.getString("passenger");
                        %>                        
                            <tr>
						...
						<%      				 					      			  
		            				...
		            				try {
		            					sql = con.prepareStatement("select username,phnno from user where emailid=?");
