    ...
    <div class="container">
        <div class="row row-content">
            <div class="col-12 col-sm-9">
                <h2>List of All Available Drivers</h2>
                    ...
                    <table class="table table-striped">
                        ...
                        <%
	                        try {
		            			...
		            			PreparedStatement st=  con.prepareStatement("select username,emailid,phnno from drivers where emailid In (select email from driverStatus where status=?)");
		            			st.setString(1, "free");
